...
@REM #
ngdbuild -p xc6slx45fgg676-2 -nt timestamp -bm battle_city.bmm "D:/materija/RA218-2015/LPRS2/projekat/new_rally_x/battle_city_design/implementation/battle_city.ngc" -uc battle_city.ucf battle_city.ngd 
